...
class MyEffect(inkex.Effect):
  ...
  def effect(self):
    ...
    #print self.context.codes
if __name__ == '__main__':   #pragma: no cover
  e = MyEffect()
  e.affect(['--tab="plotter_setup"', '--pen-up-angle=50', '--pen-down-angle=30', '--start-delay=150', '--stop-delay=150', '--xy-feedrate=3500', '--z-feedrate=150', '--z-height=0', '--finished-height=0', '--register-pen=true', '--x-home=0', '--y-home=0', '--num-copies=1', '--continuous=false', '--pause-on-layer-change=false', 'sample1.svg'])
