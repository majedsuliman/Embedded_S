...
def beziertatlength(bx0,by0,bx1,by1,bx2,by2,bx3,by3, l, tolerance):
    global balfax,balfbx,balfcx,balfay,balfby,balfcy
    ax,ay,bx,by,cx,cy,x0,y0=bezierparameterize(bx0,by0,bx1,by1,bx2,by2,bx3,by3)
    balfax,balfbx,balfcx,balfay,balfby,balfcy = 3*ax,2*bx,cx,3*ay,2*by,cy
    t = 1.0
...
if __name__ == '__main__':
   # import timing
    ...
    beziertatlength(curves[0],curves[1],curves[2],curves[3],curves[4],curves[5],curves[6],curves[7],0.5,0.001)
    beziertatlength(curves[8],curves[9],curves[10],curves[11],curves[12],curves[13],curves[14],curves[15],0.5,0.001)
    beziertatlength(curves[16],curves[17],curves[18],curves[19],curves[20],curves[21],curves[22],curves[23],0.5,0.001)
    beziertatlength(curves[24],curves[25],curves[26],curves[27],curves[28],curves[29],curves[30],curves[31],0.5,0.001)
    beziertatlength(curves[32],curves[33],curves[34],curves[35],curves[36],curves[37],curves[38],curves[39],0.5,0.001)
